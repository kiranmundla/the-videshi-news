...
SELECT cron.unschedule('p2-ingest-cron') WHERE EXISTS (SELECT 1 FROM cron.job WHERE jobname = 'p2-ingest-cron');
...
SELECT cron.schedule(
  ...
  SELECT net.http_post(
    url := 'https://lboecaekpynbpyijrbfz.supabase.co/functions/v1/p2-ingest',
