...
# VVIP person handles and company handles — loaded from Supabase social_accounts table
sys.path.insert(0, PIPELINE_DIR)
from social_registry import load_vvip_handles, load_company_handles
VVIP_HANDLES = load_vvip_handles()
COMPANY_HANDLES = load_company_handles()
