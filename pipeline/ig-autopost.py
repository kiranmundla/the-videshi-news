...
try:
    ...
    if not reel_url:
        # No prebuilt reel available — skip reel, post stories/carousel only
        # Old generate-reel.py fallback removed: all reels now come from
        # shotstack-reel.py via the prebuilt_reels table.
        print("No prebuilt reel available — skipping reel post this cycle.")
        print("Reels are generated by the videshi-shotstack-reels cron.")
