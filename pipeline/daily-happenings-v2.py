...
FESTIVALS_2026 = {
    ...
    "2026-03-10": ("🎨", "Holi — Festival of Colors"),
    "2026-03-30": ("🛕", "Ugadi / Gudi Padwa"),
    "2026-04-02": ("🕉️", "Ram Navami"),
    ...
    "2026-09-12": ("☪️", "Milad un-Nabi"),
    "2026-09-22": ("🔱", "Navratri Begins"),
    "2026-10-01": ("🏹", "Dussehra / Vijayadashami"),
    "2026-10-20": ("🪔", "Diwali — Festival of Lights"),
    "2026-10-22": ("🎊", "Bhai Dooj"),
    "2026-11-08": ("🕯️", "Guru Nanak Jayanti"),
