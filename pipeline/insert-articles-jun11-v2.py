#!/usr/bin/env python3
"""Insert 3 articles for The Videshi - June 11, 2026 batch (fixed columns)"""
...
articles.append({
    "id": str(uuid.uuid4()),
    "headline": "Microplastics Are Accumulating in Human Brains at Alarming Rates — And the Diaspora Should Pay Attention",
    ...
    "status": "review",
    "is_editorial": False,
    "image_url": "https://upload.wikimedia.org/wikipedia/commons/e/e2/Microplastics-in-ocean_%28OWID_0661%29.png",
    "image_caption": "Visualization of microplastic distribution in the world's oceans — the same particles now found accumulating in human brain tissue",
    "image_attribution": "Our World in Data / Wikimedia Commons",
    "diaspora_angle": "Plastic packaging ubiquity in Indian food culture, takeaway habits, and water quality create heightened exposure for South Asian diaspora families",
    "urgency": "medium",
    "tags": ["microplastics", "brain-health", "dementia", "plastic-pollution", "health-research", "diaspora-health"],
    "published_at": now,
    "sources": [
        {"name": "Nature Medicine", "url": "https://www.nature.com/nm/"},
        {"name": "JAMA Network Open", "url": "https://jamanetwork.com/journals/jamanetworkopen"},
...
# ARTICLE 2: Smartphones at 13
articles.append({
    "id": str(uuid.uuid4()),
    "headline": "Getting a Smartphone at 13 Wrecks Sleep by 14 — A New Study That Every Desi Parent Needs to Read",
    ...
    "status": "review",
    "is_editorial": False,
    "image_url": "https://images.pexels.com/photos/10387709/pexels-photo-10387709.jpeg?auto=compress&cs=tinysrgb&w=800",
    "image_caption": "Teenager using a smartphone at night — the glow that costs a generation its sleep",
    "image_attribution": "Ron Lach / Pexels",
    "diaspora_angle": "South Asian parenting norms around academic phone use, late-night studying, and family WhatsApp connectivity create unique tension with smartphone delay recommendations",
    "urgency": "medium",
    "tags": ["smartphones", "teen-health", "sleep", "depression", "parenting", "diaspora-families", "screen-time"],
    "published_at": now,
    "sources": [
        {"name": "JAMA Pediatrics", "url": "https://jamanetwork.com/journals/jamapediatrics"},
        {"name": "ABCD Study", "url": "https://abcdstudy.org"},
        {"name": "CHOP / UC Berkeley / UPenn", "url": "https://www.chop.edu"}
    ],
...
articles.append({
    "id": str(uuid.uuid4()),
    "headline": "India Is Rolling Out the Red Carpet for NRI Money — Here's What Changed This Week and What It Means for You",
    ...
    "status": "review",
    "is_editorial": False,
    "image_url": "https://upload.wikimedia.org/wikipedia/commons/a/a8/Reserve_Bank_of_India_Building.jpg",
    "image_caption": "The Reserve Bank of India building — the institution driving the most aggressive NRI investment reforms in a decade",
    "image_attribution": "Wikimedia Commons (CC BY-SA)",
    "diaspora_angle": "Direct financial impact on NRI savings, FCNR deposits, equity PIS accounts, and government bond investments — actionable for every diaspora family with India ties",
    "urgency": "high",
    "tags": ["nri-investment", "rbi", "fcnr-deposits", "government-bonds", "india-finance", "diaspora-money", "fpi-tax-free"],
    "published_at": now,
    "sources": [
