...
def insert_article(article_json):
    """Insert article via videshi-db.py"""
...
def update_topic_status(topic_id, status):
    """Mark topic as published or rejected."""
    result = subprocess.run(
...
# ═══════════════════════════════════════════════════════
# ARTICLE 1 — news
# India-Pakistan: One Year After Sindoor
# ═══════════════════════════════════════════════════════
...
article2 = {
    ...
    "image_search_query": "USCIS office immigration petition signature",
...
"This is a compliance trap," said one New York-based immigration attorney who asked not to be named because their firm represents major Indian IT outsourcing companies. "You're asking employers to guarantee that every signature on every form in a multi-document filing was applied with a physical pen on the original page. That's not how modern business works."
...
article3 = {
    ...
    "urgency": "daily",
    "score_total": 80,
    "diaspora_angle": "NRIs sending money home are getting the best exchange rate in history — every $1,000 now converts to nearly ₹96,000 versus ₹83,000 two years ago. But the same forces weakening the rupee (oil shocks, inflation, capital flight) also erode the purchasing power of those rupees once they land in India.",
    ...
    "image_must_show": "Indian rupee currency or forex trading screen",
    "image_search_query": "Indian rupee currency notes 2026",
...
**Capital flight.** Foreign portfolio investors have withdrawn over ₹2.6 lakh crore (approximately $27 billion) from Indian equities in 2026, the most sustained outflow since the taper tantrum of 2013. Rising US interest rates and geopolitical risk have made emerging markets broadly unattractive, but India's energy vulnerability has made it a particular target. The FII selling is self-reinforcing: as the rupee weakens, foreign investors face additional currency losses on their Indian holdings, incentivising further exits.
...
But economists are increasingly blunt about the limits of intervention. "The rupee needs a deep reset, not a quick fix," analysts at Mint quoted one chief economist as saying. Structural reforms — reducing oil import dependency, boosting manufactured exports, accelerating domestic energy production — are the only lasting solutions, and none of them operate on the timeline of a forex crisis.

## The NRI Paradox

For the Indian diaspora, the rupee's weakness creates a peculiar paradox. Dollar-earners sending money to India are getting historically favourable exchange rates. A software engineer in Sunnyvale remitting $2,000 a month now delivers nearly ₹192,000 to family in India — compared to ₹166,000 at the same exchange rate two years ago. That is a meaningful difference for parents' medical bills, siblings' education fees, or property EMIs.
...
# Topics covered by Article 1 (India-Pakistan tensions)
article1_topics = [
    "d8311a48-054",  # Indian Army Chief Warns Pakistan on Harbouring Terrorists
    "58e0de45-2db",  # Indian Army Chief Issues Stern Warning  
    "b57e16f5-7a2",  # India Rejects Pakistan-Backed Court of Arbitration
    "6e9aab87-ab1",  # Mehbooba Mufti Backs RSS Leader's Call
    "2f31e8c8-6b9",  # Pakistan Army Criticizes Indian Army Chief
    "0a7c8090-438",  # India and Pakistan's Nuclear Arsenals
]

# Topics covered by Article 2 (USCIS)
article2_topics = [
    "dfba732b-6104-4323-80ca-86b55c564603",  # US Immigration Crackdown
    "2724e566-fe57-4f09-bad0-28afe2252ea9",  # New USCIS Signature Rule
]

# Topics covered by Article 3 (Rupee)
article3_topics = [
    "54517ca0-c25",  # Rupee Breaches 96 Against US Dollar
]

# I only have partial IDs for some topics. Let me query full IDs first.
print("Updating topics with full IDs...")
