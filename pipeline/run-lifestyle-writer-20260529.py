#!/usr/bin/env python3
"""Lifestyle-health + markets-finance writer run for 2026-05-29."""

import json, os, sys, uuid, urllib.parse, subprocess, time
...
def fetch_pexels_image(query, fallback_query=None):
    """Fetch a relevant image from Pexels. Use curl-style approach."""
    if not PEXELS_KEY:
    ...
    for q in [query, fallback_query]:
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"  ⚠ Pexels returned {r.status_code} for '{q}'")
...
# ============================================================
# ARTICLE 1: Lifestyle-health — Yale/Nature Genetics study
# ============================================================

article1_body = """Your Fitbit logged 9,000 steps yesterday. You carried groceries up two flights of stairs. You paced through three back-to-back meetings. By every casual measure, you moved plenty.
...
article1 = {
    ...
    'image_search': 'person jogging morning park recreational exercise',
    'image_fallback': 'outdoor running fitness leisure exercise'
}


# ============================================================
# ARTICLE 2: Lifestyle-health — Vaping / e-cigarette cancer risk
# ============================================================

article2_body = """For years, the pitch has been simple: vaping is safer than smoking. Millions of parents heard it and exhaled in relief. If their teenager was going to do something, at least it was not cigarettes.
...
Dr Leana Wen, an emergency physician and adjunct associate professor at George Washington University, summarised the problem in a CNN interview this week: "I worry that 'safer than cigarettes' is often interpreted as 'safe,' and that is not supported by the evidence."
...
article2 = {
    ...
    'image_search': 'teenager e-cigarette vape smoke',
    'image_fallback': 'vaping electronic cigarette close up'
}


# ============================================================
# ARTICLE 3: Markets-finance — RBI June 5 policy decision
# ============================================================

article3_body = """The Reserve Bank of India's Monetary Policy Committee will meet from June 3 to June 5. The decision it announces on Thursday will be the most consequential in at least two years — and the most difficult.
...
article3 = {
    ...
    'image_search': 'Reserve Bank India building Mumbai',
    'image_fallback': 'Indian rupee currency notes banking'
}
...
print("=" * 60)
print(f"The Videshi — Lifestyle + Markets Writer")
...
for i, article in enumerate(articles, 1):
    ...
    img_url = fetch_pexels_image(article['image_search'], article.get('image_fallback'))
    ...
    if img_url:
        ...
        print(f"  ⚠ No suitable image found — publishing without image")
