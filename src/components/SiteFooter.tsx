      ...
      <div className="container py-10 grid gap-8 md:grid-cols-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://threads.com/@the.videshi" target="_blank" rel="noopener noreferrer" className="text-foreground/70 hover:text-foreground transition-colors" aria-label="Follow us on Threads">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
