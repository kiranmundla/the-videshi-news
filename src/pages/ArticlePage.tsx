          ...
          <div className="mt-6 flex flex-wrap gap-x-2 gap-y-1 text-xs text-muted-foreground items-center">
            ...
            <span className="ml-auto flex gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-full bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 transition-colors text-xs font-medium"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-full bg-foreground/5 text-foreground/60 hover:bg-foreground/10 transition-colors text-xs font-medium"
